export const profiling_data = {
  ...
  throughput: {
    samples_per_second: 437.0670166015625,
    predicted_max_samples_per_second: 482.1194763183594,
    run_time_ms: [2.0741746243490233, 2.987123488875724],
    peak_usage_bytes: [83790235.71134023, 411036049.1546396],
    batch_size_context: "entry_point.py,11",
    can_manipulate_batch_size: true,
  },
  breakdown: {
    peak_usage_bytes: 1730847744,
    memory_capacity_bytes: 25769803776,
    iteration_run_time_ms: 36.515499114990234,
    batch_size: 16,
  ...
  habitat: [
    ["source", 35.13387680053711],
    ["P4000", 167.90575408935547], // 67.90575408935547
    ["P100", 131.393720626831055],
    ["V100", 19.372163772583008],
    ["T4", 48.79145431518555],
